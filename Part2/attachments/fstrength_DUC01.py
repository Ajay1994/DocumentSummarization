...
#print test2
	...
	print "avg sentence strength list:"
	print ss
	...
	#fi2=open("out_strength.txt", 'w')
	
	
	x=0
	m=[]
	sl=[]
	n=[i[0] for i in sorted(enumerate(ss), key=lambda x:x[1], reverse=True)]
	print n
